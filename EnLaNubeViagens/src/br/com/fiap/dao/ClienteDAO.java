...
public class ClienteDAO extends Dao{
	...
	private final String INSERT_QUERY = "INSERT INTO enlanube.cliente (user, senha, cpf, nome, dtNascimento," +
										"email,telefone, endereco,numero, estado,cep, complemento)" +
										"VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
	private final String SELECT_ALL_QUERY = "SELECT * FROM enlalube.cliente";
	private final String SELECT_BY_ID = "SELECT * FROM enlalube.cliente where idcliente = ?";
	private final String SELECT_BY_USER_SENHA = "SELECT * FROM enlalube.cliente where user = ? AND senha = ?";
